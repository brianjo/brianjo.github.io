.. note::
    ...
    Click :ref:`here <sphx_glr_download_beginner_nlp_word_embeddings_tutorial.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_beginner_nlp_word_embeddings_tutorial.py:
...
.. _sphx_glr_download_beginner_nlp_word_embeddings_tutorial.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: word_embeddings_tutorial.py <word_embeddings_tutorial.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: word_embeddings_tutorial.ipynb <word_embeddings_tutorial.ipynb>`
