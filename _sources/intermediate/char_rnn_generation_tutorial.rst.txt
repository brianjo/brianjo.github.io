.. note::
    ...
    Click :ref:`here <sphx_glr_download_intermediate_char_rnn_generation_tutorial.py>` to download the full example code
...
.. _sphx_glr_download_intermediate_char_rnn_generation_tutorial.py:
